          ...
          <div class="flex">
            ...
            <div class="hidden sm:-my-px sm:ml-6 sm:flex sm:space-x-8">
              <RouterLink
                ...
                active-class="border-indigo-600 text-gray-900 dark:border-indigo-500 dark:text-white"
                inactive-class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 dark:text-gray-400 dark:hover:border-white/20 dark:hover:text-gray-200"
              >
                Dashboard
              </RouterLink>
              <RouterLink
      ...
      <el-disclosure id="mobile-menu" hidden class="block sm:hidden">
        <div class="space-y-1 pt-2 pb-3">
          <RouterLink
            ...
            active-class="border-indigo-600 bg-indigo-50 text-indigo-700 dark:border-indigo-500 dark:bg-indigo-600/10 dark:text-indigo-300"
            inactive-class="border-transparent text-gray-600 hover:border-gray-300 hover:bg-gray-50 hover:text-gray-800 dark:text-gray-400 dark:hover:border-gray-500 dark:hover:bg-white/5 dark:hover:text-gray-200"
          >
            Dashboard
          </RouterLink>
          <RouterLink
